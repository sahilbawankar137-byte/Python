...
#1.WAP to ask the user to enter names of their 3 fovorite movies & store them in a list.
...
#3.WAP to count a number of students with the "A" grade in the following tuple.
